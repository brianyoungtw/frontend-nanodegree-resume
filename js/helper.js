...
var HTMLprojectImage = '<img src="%data%" id="proj-pic">';
...
var HTMLaudio = '<audio controls id="audio"><source src="./music/ode_to_joy.mp3" type="audio/mpeg">Your browser does not support the audio element.</audio>';
